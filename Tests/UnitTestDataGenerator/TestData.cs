...
namespace UnitTests
{
    ...
    internal static class TestData
    {
        public static IEnumerable<(string testItemName, byte[] serialised)> GetItems()
        {
            ...
            yield return ("MsgPack5.H5.Tests.SharedTestItems.Primitives.TestFloatMin", new byte[] { 202, 255, 127, 255, 255 });
            ...
            yield return ("MsgPack5.H5.Tests.SharedTestItems.Primitives.TestIntMin", new byte[] { 210, 128, 0, 0, 0 });
            ...
            yield return ("MsgPack5.H5.Tests.SharedTestItems.Primitives.TestLongMin", new byte[] { 211, 128, 0, 0, 0, 0, 0, 0, 0 });
            ...
            yield return ("MsgPack5.H5.Tests.SharedTestItems.Primitives.TestSByteMin", new byte[] { 208, 128 });
            ...
            yield return ("MsgPack5.H5.Tests.SharedTestItems.Primitives.TestShortMin", new byte[] { 209, 128, 0 });
