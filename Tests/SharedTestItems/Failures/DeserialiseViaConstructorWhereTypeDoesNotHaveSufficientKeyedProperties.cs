...
namespace MessagePack.Tests.SharedTestItems.Failures
{
    ...
    /// </summary>
    internal sealed class DeserialiseViaConstructorWhereTypeDoesNotHaveSufficientKeyedProperties : FailureTestItem<ClassWithIntProperty, ClassWithIntAndStringViaConstructorArgumentsButOnlyOneIntProperty>
    {
        public DeserialiseViaConstructorWhereTypeDoesNotHaveSufficientKeyedProperties() : base(new ClassWithIntProperty { Key = 123 }) { }
    }
}