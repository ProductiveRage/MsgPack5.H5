...
namespace MessagePack.Tests.SharedTestItems.Failures
{
    ...
    /// </summary>
    internal sealed class ConstructorArgumentsMustHaveKeyedPropertiesForEachArgument : FailureTestItem<ClassWithNonConsecutiveKeyProperties, ClassWithNonConsecutiveKeyPropertiesSetByConstructor>
    {
        public ConstructorArgumentsMustHaveKeyedPropertiesForEachArgument() : base(new ClassWithNonConsecutiveKeyProperties { Key = 123, ID = "ABC" }) { }
    }
}